...
<?php endif; ?>
        <?php elseif($icon): ?>
            <div
                <?php echo e($icon->attributes->merge()); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'shrink-0 h-lh']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    <?php endif; ?>
    <?php if(gettype($label ?? $slot) === 'object'): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /var/www/allyouneed.local/storage/framework/views/c465ea24dda6ded776ea154117706fec.blade.php ENDPATH**/ ?>