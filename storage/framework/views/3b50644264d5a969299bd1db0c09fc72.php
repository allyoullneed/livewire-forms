    <div
        ...
        :class="theme === '<?php echo e($darkTheme); ?>' ? 'theme-toggle--toggled' : ''"
    >
    <?php if($type === 'around'): ?>
        <svg
    ...
    <?php elseif($type === 'innermoon' || $type === 'inner-moon'): ?>
        <svg
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
            fill="currentColor"
    ...
    <?php elseif($type === 'lightbulb' || $type === 'light-bulb'): ?>
        <svg
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
    ...
    <?php endif; ?>
    </div><?php /**PATH /var/www/allyouneed.local/storage/framework/views/fbfc08152ba8998c2bc36687295c2637.blade.php ENDPATH**/ ?>